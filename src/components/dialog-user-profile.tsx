...
const DialogUserProfile: React.FC<DialogUserProfileProps> = ({open, onClose, user, isAdd, branches, roles}) => {
        ...
        >
            <div className={'flex flex-col p-4 pl-6 pr-6'}>
                <div>
                    ...
                    {!isAdd &&<span style={{fontWeight: 'bold', fontSize: '1.2rem', color: bg_blue_500}}>Thông tin người dùng</span>}
                </div>
